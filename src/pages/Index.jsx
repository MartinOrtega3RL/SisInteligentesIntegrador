...
// Importo los componentes, para no hacer el codigo remil largo
...
import SignSearch from "../components/ai/SignSearch";

// Aca importo los datos, lo tengo estructurado en un Json
...
const Index = () => {
  ...
  const [signSearchVisible, setSignSearchVisible] = useState(false); // 2. Estado para el modal

  // Esta es una funcion que me permite hacer scroll a las secciones de la pagina/ reciclado de GrupoSeguros
    ...
    <Layout className="min-h-screen">
      ...
      <Content className="pt-16">
        ...
        <HeroSection
          ...
          onOpenSignSearch={() => setSignSearchVisible(true)} // <-- agrega esta prop
        />

        <Modal
          open={signSearchVisible}
          onCancel={() => setSignSearchVisible(false)}
          footer={null}
          title="Buscar en la página usando señas"
          destroyOnClose
        >
          <SignSearch onClose={() => setSignSearchVisible(false)} />
        </Modal>
      ...
      <section id="que-es-ia" className="py-20 bg-background">
        <div className="max-w-6xl mx-auto px-4">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-5xl font-bold mb-6 ai-text-gradient">
              ¿Qué es la Inteligencia Artificial?
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              La Inteligencia Artificial es la simulación de procesos de
              inteligencia humana por parte de máquinas, especialmente
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <Card className="hover:shadow-lg transition-shadow">
              ...
              <p className="text-muted-foreground mb-4">
                La IA es un campo de la informática que se dedica a crear
                sistemas capaces de realizar tareas que normalmente requieren
                inteligencia humana, como el reconocimiento de patrones, la
            ...
            <TabPane tab="Tipos de IA" key="1">
              <div className="grid md:grid-cols-3 gap-6">
                <Card title="IA Débil" className="text-center">
                  <p>
                    Sistemas diseñados para tareas específicas. Ejemplo:
                    calculadoras, GPS.
                  </p>
                </Card>
                <Card title="IA General" className="text-center">
                  <p>
                    Sistemas con capacidades cognitivas similares a las
                    humanas (aún en desarrollo).
                  </p>
                </Card>
                <Card title="Superinteligencia" className="text-center">
                  <p>
                    IA que supera la inteligencia humana en todos los aspectos
                    (hipotética).
                  </p>
                </Card>
              </div>
      ...
      <section id="machine-learning" className="py-20 bg-muted/30">
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              El aprendizaje automático permite a las máquinas aprender y
          ...
          <Collapse defaultActiveKey={["1"]} className="mb-8">
            <Panel header="¿Cómo funciona el Machine Learning?" key="1">
              <div className="space-y-4">
                <p>
                  El Machine Learning funciona mediante algoritmos que
                  analizan datos, identifican patrones y hacen predicciones o
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <Card size="small" title="1. Datos">
                    <p>
                      Recopilación y preparación de grandes cantidades de
                      datos relevantes.
                    </p>
                  </Card>
                  <Card size="small" title="2. Algoritmo">
                    <p>
                      Selección del modelo matemático apropiado para el
                      problema.
                    </p>
                  </Card>
                  <Card size="small" title="3. Entrenamiento">
                    <p>
                      El algoritmo aprende patrones a partir de los datos de
                      entrenamiento.
                    </p>
                  </Card>
                </div>
            ...
            <Panel header="Aplicaciones Prácticas" key="3">
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <Card size="small" className="text-center">
                  <h4>Salud</h4>
                  <p className="text-sm">
                    Diagnóstico por imágenes, descubrimiento de medicamentos
                  </p>
                </Card>
                <Card size="small" className="text-center">
                  <h4>Marketing</h4>
                  <p className="text-sm">
                    Segmentación de clientes, personalización
                  </p>
                </Card>
                <Card size="small" className="text-center">
                  <h4>Transporte</h4>
                  <p className="text-sm">
                    Optimización de rutas, mantenimiento predictivo
                  </p>
                </Card>
              </div>
            </Panel>
      ...
      <section id="deep-learning" className="py-20 bg-background">
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              El aprendizaje profundo utiliza redes neuronales artificiales
              con múltiples capas para modelar y entender datos complejos.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            <Card className="p-6">
              ...
              <p className="mb-4">
                Inspiradas en el cerebro humano, las redes neuronales están
                compuestas por nodos (neuronas) interconectados que procesan
                información.
              </p>
            ...
            <Card className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Para datos secuenciales como texto y audio
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Arquitectura base de GPT y BERT
                  </p>
                </div>
              </div>
            </Card>
      ...
      <section id="tipos-aprendizaje" className="py-20 bg-muted/30">
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Los algoritmos de IA aprenden de diferentes maneras según el
              tipo de datos y supervisión disponible.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <Card className="h-full text-center p-6 hover:shadow-lg transition-shadow">
                ...
                <p className="mb-4">
                  El algoritmo aprende a partir de ejemplos etiquetados, donde
            ...
            >
              <Card className="h-full text-center p-6 hover:shadow-lg transition-shadow">
                ...
                <p className="mb-4">
                  El algoritmo encuentra patrones ocultos en datos sin
                  etiquetas previas.
                </p>
                <div className="text-left space-y-2">
                  <p>
            ...
            >
              <Card className="h-full text-center p-6 hover:shadow-lg transition-shadow">
                ...
                <p className="mb-4">
                  El algoritmo aprende mediante prueba y error, recibiendo
      ...
      <section id="agentes" className="py-20 bg-background">
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Un agente inteligente es una entidad que percibe su entorno y
              actúa de manera autónoma para alcanzar objetivos específicos.
            </p>
          </motion.div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Recibe información del entorno a través de sensores
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Procesa la información para tomar decisiones
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Ejecuta acciones para modificar el entorno
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Mejora su desempeño basado en la experiencia
                    </p>
                  </div>
                </div>
              </div>
            ...
            <Card className="p-6">
              ...
              <Tabs defaultActiveKey="1">
                <TabPane tab="Reactivos" key="1">
                  <p className="mb-2">
                    Responden directamente a estímulos del entorno sin memoria
                    del pasado.
                  </p>
                  <p className="text-sm text-muted-foreground">
                    Ejemplo: Termostato, sistemas de alarma
                  </p>
                </TabPane>
                <TabPane tab="Basados en Modelos" key="2">
                  <p className="mb-2">
                    Mantienen un modelo interno del mundo para tomar mejores
                    decisiones.
                  </p>
                  <p className="text-sm text-muted-foreground">
                    Ejemplo: GPS, robots de limpieza
                  </p>
                </TabPane>
                <TabPane tab="Basados en Objetivos" key="3">
                  <p className="mb-2">
                    Actúan para alcanzar objetivos específicos definidos.
                  </p>
                  <p className="text-sm text-muted-foreground">
                    Ejemplo: Asistentes virtuales, planificadores
                  </p>
                </TabPane>
                <TabPane tab="Basados en Utilidad" key="4">
                  <p className="mb-2">
                    Optimizan una función de utilidad para maximizar su
                    desempeño.
                  </p>
                  <p className="text-sm text-muted-foreground">
                    Ejemplo: Sistemas de recomendación, trading bots
                  </p>
                </TabPane>
              </Tabs>
            </Card>
      ...
      <section id="busqueda" className="py-20 bg-muted/30">
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Las técnicas de búsqueda heurística permiten encontrar
              soluciones eficientes a problemas complejos usando "reglas de
              oro" o estimaciones inteligentes.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            <Card className="p-6">
              ...
              <p className="mb-4">
                Una heurística es una técnica diseñada para resolver un
                problema más rápidamente cuando los métodos clásicos son
                demasiado lentos, o para encontrar una solución aproximada
                cuando no es posible encontrar una solución exacta.
              </p>
            ...
            <Card className="p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="border-l-4 border-purple-500 pl-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Búsqueda local que siempre se mueve hacia mejores
                    soluciones
                  </p>
                </div>
              </div>
          ...
          {/* Ejemplo del Algoritmo A* Con Animacion */}
          <AStarVisualizer />
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="p-6">
              ...
              <ul className="space-y-2">
                <li>
                  • <strong>Navegación GPS:</strong> Encontrar rutas óptimas
                </li>
                <li>
                  • <strong>Juegos:</strong> IA para videojuegos (pathfinding)
                </li>
                <li>
                  • <strong>Robótica:</strong> Planificación de movimientos
                </li>
                <li>
                  • <strong>Optimización:</strong> Problemas de scheduling
                </li>
                <li>
                  • <strong>Bioinformática:</strong> Alineación de secuencias
                </li>
              </ul>
            </Card>
            ...
            <Card className="p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="text-sm space-y-1">
                    <li>
                      • Reducen significativamente el tiempo de búsqueda
                    </li>
                    <li>
                      • Proporcionan soluciones "suficientemente buenas"
                    </li>
  ...
  <Footer className="bg-gray-900 text-white py-12">
    <div className="max-w-6xl mx-auto px-4">
      <div className="grid md:grid-cols-3 gap-8">
        <div>
          <h3 className="text-xl font-semibold mb-4 ai-text-gradient">
            Explorando la IA
          </h3>
          <p className="text-gray-300">
            Pagina web para enseñar los temas dados en la materia sobre la
            Inteligencia Artificial de manera interactiva y accesible.
          </p>
        </div>
        <div>
      ...
      <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
        <p>
          &copy; 2027 Explorando la Inteligencia Artificial. Hecho con ❤️ para la Materia
        </p>
      </div>
    </div>
  </Footer>
